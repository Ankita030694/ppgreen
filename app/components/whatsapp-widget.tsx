...
export default function WhatsAppWidget() {
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-2 group">
      ...
      <div className="bg-white text-[#0C433C] text-xs sm:text-sm font-medium px-4 py-2 rounded-xl shadow-lg border border-zinc-100 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none flex items-center gap-2 mb-1">
      ...
      {/* WhatsApp Button */}
      <a
        href="https://wa.me/918222833351"
        target="_blank"
        rel="noopener noreferrer"
        className="relative flex items-center justify-center w-14 h-14 rounded-full bg-[#25D366] text-white shadow-xl hover:bg-[#22c35e] transition-all duration-300 hover:scale-110 active:scale-95"
