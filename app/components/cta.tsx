    ...
    <section id="cta" className="relative w-full bg-white text-[#0C433C] pt-[50px] pb-0 overflow-hidden">
      ...
      <div className="reveal-on-scroll reveal-delay-150 relative w-full mt-12 md:mt-24">
              ...
              <div className="p-8 flex flex-col gap-6 bg-white">
                ...
                <div className="flex items-start gap-4">
                  <div className="flex-shrink-0 w-5 h-5 mt-1 flex items-center justify-center">
                    <svg className="w-5 h-5 text-[#0C433C]/60" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
                    </svg>
                  </div>
                  <div className="flex flex-col">
                    <span className="text-[#0C433C]/60 text-xs uppercase tracking-wider mb-0.5">Email</span>
                    <a href="mailto:Sales@ppgreencity.com" className="text-sm sm:text-base font-medium text-[#0C433C] hover:text-orange-500 transition-colors duration-300">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex flex-col">
                    <span className="text-[#0C433C]/60 text-xs uppercase tracking-wider mb-0.5">Phone</span>
                    <a href="tel:+918222-8333-51" className="text-sm sm:text-base font-medium text-[#0C433C] hover:text-orange-500 transition-colors duration-300">
                      +91 8222-8333-51
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex flex-col">
                    <span className="text-[#0C433C]/60 text-xs uppercase tracking-wider mb-0.5">Office</span>
                    <p className="text-sm sm:text-base font-medium text-[#0C433C] leading-relaxed">
        ...
        <div className="absolute top-[-30px] right-4 w-[58%] min-w-[200px] max-w-[270px] bg-white z-10 flex flex-col border border-zinc-100 shadow-xl md:hidden">
          ...
          {/* Contact details */}
          <div className="p-4 flex flex-col gap-4 bg-white text-[#0C433C]">
            {/* Email */}
            <div className="flex flex-col items-start gap-1">
              <svg className="w-4 h-4 text-[#0C433C]/70" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
              </svg>
