...
export default function CTA() {
  const handleGetInTouch = () => {
    // Scroll to contact form or perform action
  ...
  return (
    <section id="cta" className="relative w-full bg-white text-black pt-16 pb-20 sm:pt-24 sm:pb-32 overflow-hidden">
      <div className="mx-auto max-w-8xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative w-full mt-12 md:mt-24">
          ...
          {/* Image Container */}
          <div className="relative w-full aspect-[16/10] md:aspect-[21/9] min-h-[280px] md:min-h-[420px] overflow-hidden shadow-sm border border-zinc-100">
            <Image
              src="/CTA.svg"
              alt="Ready to build?"
              fill
          ...
          <div className="relative md:absolute md:-top-24 md:right-12 mt-6 md:mt-0 w-full md:w-[380px] bg-white  z-10 flex flex-col border border-zinc-100">
